...
<div class="card m-3 shadow-sm" style="width: 320px;">
    ...
    @if($interaction)
        ...
        @if($interaction->check === 'yes')
            <div id="{{ $post_id }}" class="check-btn" style="color:rgb(20, 128, 56);" data-toggle="tooltip" data-placement="left" title="Post read">
                <i class="fas fa-check"></i>
            </div>
        @else
            <div id="{{ $post_id }}" class="check-btn" style="color:rgb(185, 185, 185);" data-toggle="tooltip" data-placement="left" title="Did you read this?">
                <i class="fas fa-check"></i>
            </div>
        @endif
